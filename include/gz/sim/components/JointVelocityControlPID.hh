 ...
 *
 */
#ifndef GZ_SIM_COMPONENTS_JOINTVELOCITYCONTROLPID_HH_
#define GZ_SIM_COMPONENTS_JOINTVELOCITYCONTROLPID_HH_
...
namespace components
{
  ...
  GZ_SIM_REGISTER_COMPONENT(
      "gz_sim_components.JointVelocityControlPID", JointVelocityControlPID)
}
}
}
}
